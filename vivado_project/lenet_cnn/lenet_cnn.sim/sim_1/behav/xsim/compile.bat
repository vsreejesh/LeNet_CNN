...
REM
REM Generated by Vivado on Sat Dec 06 20:06:44 +0530 2025
...
echo "xvlog --incr --relax -prj tb_LeNet_vlog.prj"
call xvlog  --incr --relax -prj tb_LeNet_vlog.prj -log xvlog.log
