...
This repository contains modified project files based on the original work from  
[LeNet-CNN-Accelerator-Hardware-for-FPGA](https://github.com/hazooree/LeNet-CNN-Accelerator-Hardware-for-FPGA).  
